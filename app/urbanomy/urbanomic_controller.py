...
from app.urbanomy.dto.investment_attractivness_dto import InvestmentAttractivenessDto
from app.urbanomy.modules.invest_potential_service import InvestmentPotentialService
