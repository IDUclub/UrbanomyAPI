...
The service uses a Python 3.10 compatible Machine-to-Machine Keycloak client
based on `IDUclub/idu-service-auth` when calling Urban API. Configure these
